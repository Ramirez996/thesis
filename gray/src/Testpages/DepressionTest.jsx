...
  // 1. CHANGE STATE VARIABLE AND ADD REF
...
    // Automatically open chatbot if severe, otherwise leave closed and let the user open it.
    if (evaluation.result.startsWith("Severe")) {
      setIsChatbotVisible(true);
    }
    // If you always want it to open, just use: setIsChatbotVisible(true);
